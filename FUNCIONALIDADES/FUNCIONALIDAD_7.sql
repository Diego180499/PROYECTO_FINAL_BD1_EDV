    ...
    IF EXISTS (SELECT * FROM registroacademico_f1.seccion WHERE id = id_seccion_p LIMIT 1) THEN
        ...
        IF EXISTS (SELECT * FROM registroacademico_f1.periodo WHERE id = id_periodo_p LIMIT 1) THEN
            ...
            IF EXISTS (SELECT * FROM registroacademico_f1.dia WHERE id = id_dia_p LIMIT 1) THEN
                ...
                IF NO EXISTS (SELECT * FROM registroacademico_f1.dia_seccion WHERE id_seccion = id_seccion_p AND id_dia = id_dia_p LIMIT 1) THEN
                ...
                IF NO EXISTS (SELECT * FROM registroacademico_f1.periodo_seccion WHERE id_seccion = id_seccion_p AND id_periodo = id_periodo_p LIMIT 1) THEN
